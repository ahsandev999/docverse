      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-indigo-100 max-w-xl mx-auto mb-10">Join a growing community of professionals discovering a better way to handle documents. Start for free, no credit card required.</p>
